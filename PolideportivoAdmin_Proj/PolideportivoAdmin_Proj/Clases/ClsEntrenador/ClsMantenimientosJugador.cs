    ...
    class ClsMantenimientosJugador
    {
        ...
        public void ListaEquipo(DataGridView Equipos)
        {
            try
            {
                ...
                string MostrarJugadores = "SELECT J.ID_JUGADOR, concat(J.NOMBRE1, ' ' , J.NOMBRE2, ' ' , J.APELLIDO1, ' ' , J.APELLIDO2) AS 'Nombre Completo Del Jugador', T.NOMBRE_POSICION 'Tipo De Jugador', E.NOMBRE_ESTADO AS 'Estado Del Jugador'" +
